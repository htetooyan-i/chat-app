                        ...
                        <div className="flex justify-end gap-2">
                            {
                                createNewCode ? (
                                    <div className="flex gap-2 w-full">
                                        ...
                                        <button
                                            disabled={isGenerating}
                                            className={`text-sm flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-accent border border-accent font-semibold text-foreground rounded ${isGenerating ? "cursor-not-allowed opacity-70" : "hover:opacity-80 cursor-pointer"}`}
                                            onClick={async () => {
