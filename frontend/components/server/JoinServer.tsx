    ...
    return (
        <>
            ...
            <div className="flex justify-end gap-2">
                ...
                <button
                    className={`flex-1 flex justify-center items-center gap-2 px-4 py-2 bg-accent font-semibold text-foreground rounded cursor-pointer ${isLoading ? "cursor-progress opacity-70" : "hover:opacity-80"}`}
