/*
  ...
  - The values [Image,Video] on the enum `AttachmentType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "AttachmentType_new" AS ENUM ('IMAGE', 'VIDEO', 'GIF');
